...
const translations = {
  en: {
    ...
    layout: {
      heroTitle: "A caring system for creative life.",
      heroSubtitle: "A living archive of body, environment, practice, and creation."
    },
    letters: {
    ...
    home: {
      ...
      thisWeek: "this week",
      perDayThisMonth: "{hours}h / day this month",
      loadError: "The Home page could not be loaded."
    },
    input: {
      title: "Input",
    ...
    process: {
      ...
      periodReadingSubtitle: "A weekly reading of recent relationships among body, environment, practice, artistic input, and creation.",
      generatedAutomatically: "Generated automatically once each week.",
      loadingSystemReading: "Loading the latest System reading…",
      noSystemReadingYet: "No System Reading Yet",
      noSystemReadingText: "The first reading will appear after the weekly update runs.",
      checkAnalysisAccess: "Checking owner access…",
      generateAnalysis: "Generate analysis now",
      generatingAnalysis: "Generating analysis…",
      analysisGenerated: "Analysis updated successfully.",
      analysisLocked: "This week's analysis has already been generated.",
      analysisOwnerOnly: "Owner access only.",
    ...
    archiveForm: {
      subtitle: "Store writing, reflections, project records, videos, and references in one archive.",
      titleRequired: "Please enter a title.",
      bodyRequired: "Please enter the archive text.",
      videoRequired: "Please enter a video URL or description.",
      addImagesOrBookFiles: "Add Images or Book Files",
      acceptedFileTypes: "Accepted: Images, PDF, EPUB, TXT, DOC, DOCX",
      selectedFiles: "Selected Files",
      uploading: "Uploading...",
      attachmentUploadFailed: "Attachment upload failed",
      partialUploadSaved: "아카이브는 저장되었지만 하나 이상의 첨부 업로드가 실패했습니다.",
      ...
      tagsPlaceholder: "care, maintenance, body, sound",
      tagsHelp: "Separate tags with commas.",
      placeholders: {
        essay: "Write the full essay here.",
        reflection: "Write the thought or reflection you want to preserve.",
        project_log: "Record the project process, decisions, questions, or changes.",
        video: "Add a description, transcript, or notes about the video.",
        reference: "Record the reference and why it matters."
      }
    },
    daily: {
    ...
    data: {
      noRows: "No public numeric data yet."
    },
    stats: {
      totalPublic: "total public",
      thisWeek: "This week",
    ...
    system: {
      basedOnRecords: "Based on {count} records from the latest {days} days."
    },
    weave: {
      canvasEmpty: "The nightly Weave has not been generated yet.",
      summary: "{count} records · {connections} connections · threshold {threshold}"
    },
    output: {
      eyebrow: "Output",
      title: "Works emerging from the system",
      subtitle: "Selected sound, media, publication, performance, and web-based works.",
      portfolio: "Portfolio",
      portfolioHeading: "Jang Myung Sun",
      portfolioBody: "Visit the external portfolio to see selected projects, documentation, and works.",
    ...
    translate: {
      tooLong: "The selected text is too long to translate right now.",
      failed: "Translation failed.",
      translate: "Translate",
      loading: "Translating…",
      articleTranslating: "Translating this article…",
      showOriginal: "Show Original",
      showTranslation: "Show Translation",
      unavailableShowingOriginal: "Translation unavailable. Showing the original.",
      retry: "Retry",
      original: "Original",
    ...
    logForm: {
      scalePlaceholder: "1–10",
      breathingPlaceholder: "Relaxed, shallow, tight, deep and slow...",
      timeExampleShort: "Example: 45m or 1h 30m",
      timeExampleLong: "Example: 2h 30m",
      timeExampleLearning: "Example: 1h",
      bodyMovingNotesPlaceholder: "Style, distance, bodily sensation, or anything that felt relevant.",
      projectPlaceholder: "Project name",
      onePerLine: "One item per line",
      learningPlaceholder: "English, coding, reading...",
      artisticTitlePlaceholder: "Title of the work",
      creatorPlaceholder: "Artist, author, director...",
      referencePlaceholder: "What stayed with you?"
    },
    values: {
      unrecorded: "Unrecorded",
      stable: "Stable",
      softly_stable: "Softly stable",
      recovering: "Recovering",
      fragile: "Fragile",
      clear: "Clear",
      calm: "Calm",
      low_but_moving: "Low but moving",
      tired: "Tired",
      listening: "Listening",
      making: "Making",
      learning: "Learning",
      slow_but_active: "Slow but active",
      unknown: "Unknown",
      cloudy: "Cloudy",
      heavy: "Heavy",
      normal: "Normal",
    ...
    common: {
      ...
      noAlignment: "No alignment recorded.",
  ...
  ko: {
    ...
    layout: {
      heroTitle: "창작의 삶을 위한 돌보는 시스템.",
      heroSubtitle: "몸, 환경, 실천, 창작을 살아 있는 아카이브로 엮습니다."
    },
    letters: {
      title: "방명록",
    ...
    home: {
      ...
      thisWeek: "이번 주",
      perDayThisMonth: "이번 달 하루 평균 {hours}시간",
      loadError: "홈 페이지를 불러오지 못했습니다."
    },
    input: {
      title: "입력",
    ...
    process: {
      ...
      totalPublic: "공개된 총계",
      periodReading: "기간 읽기",
      periodReadingSubtitle: "최근 몸, 환경, 실천, 예술적 입력, 창작 사이의 관계를 매주 읽어냅니다.",
      generatedAutomatically: "매주 한 번 자동으로 생성됩니다.",
      loadingSystemReading: "최신 시스템 읽기를 불러오는 중…",
      noSystemReadingYet: "아직 시스템 읽기가 없습니다",
      noSystemReadingText: "첫 읽기는 주간 업데이트 이후에 나타납니다.",
      checkAnalysisAccess: "소유자 권한 확인 중…",
      generateAnalysis: "지금 분석 생성",
      generatingAnalysis: "분석 생성 중…",
      analysisGenerated: "분석이 성공적으로 업데이트되었습니다.",
      analysisLocked: "이번 주 분석은 이미 생성되었습니다.",
      analysisOwnerOnly: "소유자만 사용할 수 있습니다.",
    ...
    archiveForm: {
      subtitle: "글쓰기, 성찰, 프로젝트 기록, 비디오, 참고 자료를 하나의 아카이브에 보관합니다.",
      titleRequired: "제목을 입력해 주세요.",
      bodyRequired: "아카이브 본문을 입력해 주세요.",
      videoRequired: "비디오 URL 또는 설명을 입력해 주세요.",
      addImagesOrBookFiles: "이미지 또는 책 파일 추가",
      acceptedFileTypes: "지원 형식: 이미지, PDF, EPUB, TXT, DOC, DOCX",
      selectedFiles: "선택된 파일",
      uploading: "업로드 중...",
      attachmentUploadFailed: "첨부 업로드 실패",
      partialUploadSaved: "Archive was saved, but one or more attachments failed.",
      maximumFilesReached: "최대 파일 개수에 도달했습니다",
      fileTooLarge: "파일 크기가 너무 큽니다",
      unsupportedFileType: "지원하지 않는 파일 형식입니다",
      videoUrl: "유튜브 또는 비메오 URL",
      externalUrl: "선택 가능한 외부 링크",
      tagsPlaceholder: "돌봄, 유지, 몸, 소리",
      tagsHelp: "태그는 쉼표로 구분하세요.",
      placeholders: {
        essay: "전체 에세이를 여기에 적어 주세요.",
        reflection: "보존하고 싶은 생각이나 성찰을 적어 주세요.",
        project_log: "프로젝트 과정, 결정, 질문, 변화를 기록해 주세요.",
        video: "비디오에 대한 설명, 대본, 메모를 적어 주세요.",
        reference: "참고한 자료와 그것이 중요한 이유를 기록해 주세요."
      }
    },
    daily: {
    ...
    data: {
      noRows: "아직 공개된 숫자 데이터가 없습니다."
    },
    stats: {
      totalPublic: "공개된 총계",
      thisWeek: "이번 주",
      noRecordsThisWeek: "이번 주 기록 없음",
      record: "기록",
      records: "기록",
      hoursThisWeek: "이번 주 {hours}",
      comparedWithLastWeek: "지난주보다",
      increased: "증가",
      decreased: "감소",
      sameAsLastWeek: "지난주와 같음"
    },
    system: {
      basedOnRecords: "최근 {days}일 동안의 기록 {count}개를 바탕으로 읽었습니다."
    },
    weave: {
      canvasEmpty: "야간 위브가 아직 생성되지 않았습니다.",
      summary: "기록 {count}개 · 연결 {connections}개 · 임계값 {threshold}"
    },
    output: {
      eyebrow: "출력",
      title: "시스템에서 나온 작업들",
      subtitle: "선별된 사운드, 미디어, 출판, 퍼포먼스, 웹 기반 작업입니다.",
      portfolio: "포트폴리오",
      portfolioHeading: "장명선",
      portfolioBody: "선별된 프로젝트, 기록, 작업을 보려면 외부 포트폴리오를 방문하세요.",
    ...
    translate: {
      tooLong: "선택한 텍스트가 지금 번역하기에는 너무 깁니다.",
      failed: "번역에 실패했습니다.",
      translate: "번역",
      loading: "번역 중…",
      articleTranslating: "이 글을 번역하고 있습니다…",
      showOriginal: "원문 보기",
      showTranslation: "번역 보기",
      unavailableShowingOriginal: "번역을 불러오지 못해 원문을 표시합니다.",
      retry: "다시 시도",
      original: "원문",
      translation: "번역"
    },
    ...
    logForm: {
      scalePlaceholder: "1–10",
      breathingPlaceholder: "편안함, 얕음, 답답함, 깊고 느림...",
      timeExampleShort: "예: 45m 또는 1h 30m",
      timeExampleLong: "예: 2h 30m",
      timeExampleLearning: "예: 1h",
      bodyMovingNotesPlaceholder: "방식, 거리, 몸의 감각, 중요하게 느껴진 점을 적어 주세요.",
      projectPlaceholder: "프로젝트 이름",
      onePerLine: "한 줄에 하나씩",
      learningPlaceholder: "영어, 코딩, 읽기...",
      artisticTitlePlaceholder: "작품 제목",
      creatorPlaceholder: "작가, 저자, 감독...",
      referencePlaceholder: "무엇이 남았나요?"
    },
    values: {
      unrecorded: "기록되지 않음",
      stable: "안정적",
      softly_stable: "부드럽게 안정적",
      recovering: "회복 중",
      fragile: "여림",
      clear: "맑음",
      calm: "차분함",
      low_but_moving: "낮지만 움직임",
      tired: "지침",
      listening: "귀 기울임",
      making: "만들기",
      learning: "배우기",
      slow_but_active: "느리지만 활동적",
      unknown: "알 수 없음",
      cloudy: "흐림",
      heavy: "무거움",
      normal: "보통",
    ...
    common: {
      ...
      noObservation: "기록된 관찰이 없습니다.",
      noAlignment: "기록된 정렬이 없습니다.",
  ...
  ja: {
    ...
    process: {
      ...
      totalPublic: "公開件数",
      periodReading: "期間読み",
      periodReadingSubtitle: "最近の身体、環境、実践、芸術的入力、創作の関係を週ごとに読みます。",
      generatedAutomatically: "毎週自動的に生成されます。",
      loadingSystemReading: "最新のシステム読みを読み込んでいます…",
      noSystemReadingYet: "まだシステム読みはありません",
      noSystemReadingText: "最初の読みは週次更新後に表示されます。",
      checkAnalysisAccess: "所有者権限を確認しています…",
      generateAnalysis: "今すぐ分析を生成",
      generatingAnalysis: "分析を生成しています…",
      analysisGenerated: "分析が正常に更新されました。",
      analysisLocked: "今週の分析はすでに生成されています。",
      analysisOwnerOnly: "所有者のみ利用できます。",
...
export function t(locale, key, params = {}) {
  ...
  const value =
    getDictionaryValue(translations[normalizedLocale], key) ||
    getDictionaryValue(translations.en, key);
...
export function getIntlLocale(locale) {
  return normalizeLocale(locale) === "ko" ? "ko-KR" : "en-US";
}
