...
const translations = {
  en: {
    ...
    media: {
      ...
      addFiles: "Add files",
      uploadHelp: "Files will upload when you press Save Daily.",
      savedFiles: "Saved Files",
      waitingToUpload: "Waiting to Upload",
      remove: "Remove",
      loading: "Loading media…",
      requestFailed: "Media URL request failed.",
      untitled: "Untitled",
      ...
      collectedImage: "Collected image",
      collectedPdf: "Collected PDF",
      document: "Document",
      audio: "Audio",
      video: "Video",
      types: {
  ...
  ko: {
    ...
    media: {
      collection: "수집",
      addFiles: "파일 추가",
      uploadHelp: "일일 기록 저장을 누르면 파일이 업로드됩니다.",
      savedFiles: "저장된 파일",
      waitingToUpload: "업로드 대기 중",
      remove: "제거",
      loading: "미디어를 불러오는 중…",
      requestFailed: "미디어 URL 요청에 실패했습니다.",
      untitled: "제목 없음",
      ...
      collectedImage: "수집된 이미지",
      collectedPdf: "수집된 PDF",
      document: "문서",
      audio: "오디오",
      video: "비디오",
      types: {
